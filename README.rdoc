...
== Install Ruby Open Babel

1. download openbabel
2. swap out Init_OpenBabel for Init_openbabel in scripts/ruby/openbabel-ruby.cpp (see here[http://forums.openbabel.org/Ruby-Open-Babel-in-2-1-1-td957640.html])
...
Here's a complete example of compiling for a single user on Ubuntu 11.10 (this will compile bindings on whichever ruby comes up with '/usr/bin/env ruby'
    ...
    sed -i 's/Config::CONFIG/RbConfig::CONFIG/g' openbabel-2.3.1/scripts/ruby/openbabel-ruby.cpp
